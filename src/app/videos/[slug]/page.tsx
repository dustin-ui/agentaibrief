...
export default function VideoPlayerPage() {
  ...
  const { user, isLoggedIn, isInnerCircle, signOut } = useAuth();
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-6">
              ...
              <nav className="hidden md:flex items-center gap-4">
                <Link
                  href="/"
                  className="text-sm text-[#666] hover:text-[#2a2a2a] transition-colors"
                >
                  News
                </Link>
                <Link
      ...
      <main className="max-w-7xl mx-auto px-4 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
                ...
                <div className="absolute inset-0 flex items-center justify-center bg-black/50">
                  <div className="text-center max-w-sm px-4">
                    <div className="w-20 h-20 bg-[#e85d26]/20 rounded-full flex items-center justify-center mx-auto mb-4 border border-[#e85d26]/30">
                      <svg
                        className="w-10 h-10 text-[#e85d26]"
                        fill="none"
                        viewBox="0 0 24 24"
                        strokeWidth={1.5}
                        stroke="currentColor"
            ...
            <div className="bg-[#f0ece4] border border-[#e0dcd4] rounded-xl p-6 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-[#2a2a2a] font-semibold mb-1">
                    Dustin Fox
                  </h4>
          ...
          <div className="lg:col-span-1">
            <h3 className="text-[#2a2a2a] font-semibold mb-4 text-sm uppercase tracking-wider">
              Up Next
            </h3>
                ...
                return (
                  ...
                  >
                    <div className="relative w-40 shrink-0 aspect-video rounded-lg overflow-hidden bg-[#f0ece4]">
                      ...
                      {rvLocked && (
                        <div className="absolute inset-0 flex items-center justify-center bg-black/40">
                          <svg
                            className="w-5 h-5 text-[#2a2a2a]/80"
                            fill="none"
                            viewBox="0 0 24 24"
                            strokeWidth={1.5}
                            stroke="currentColor"
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="text-[#2a2a2a] text-sm font-medium line-clamp-2 group-hover:text-[#e85d26] transition-colors">
                        {rv.title}
                      </h4>
