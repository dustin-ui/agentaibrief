    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <img
              src="/dustin-fox.jpg"
              alt="Dustin Fox"
              className="w-36 h-36 rounded-full object-cover border-4 border-blue-500 shadow-xl shrink-0"
            />
            <div className="text-center md:text-left">
              ...
              <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                ...
                <div className="bg-white/10 rounded-lg px-4 py-2 text-center">
                  <p className="text-xl font-bold text-blue-400">115%</p>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        <article className="prose prose-lg max-w-none">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">From Solo Agent to $277M Team — Powered by AI</h2>
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-8">
            <h3 className="text-lg font-bold text-gray-900 mb-4">📈 The Numbers Tell the Story</h3>
            <div className="space-y-4">
              {[
                { year: 'Pre-ChatGPT', vol: '$129M', note: 'Solid team, traditional methods', color: 'bg-gray-300' },
                { year: '2023', vol: '$179M', note: 'First year with AI — 39% jump', color: 'bg-blue-400' },
                { year: '2024', vol: '$221M', note: 'AI in every workflow — 23% growth', color: 'bg-blue-500' },
                { year: '2025', vol: '$277M', note: 'Full AI integration — 25% growth', color: 'bg-blue-600' },
              ].map((row) => (
                <div key={row.year} className="flex items-center gap-4">
                  <div className="w-28 shrink-0">
                    <p className="text-sm font-bold text-gray-900">{row.year}</p>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center gap-3">
                      <div className={`h-3 rounded-full ${row.color}`} style={{ width: `${(parseInt(row.vol.replace(/\D/g, '')) / 277) * 100}%` }} />
                      <span className="text-sm font-bold text-gray-900 whitespace-nowrap">{row.vol}</span>
                    </div>
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-4">Why I Built AgentAIBrief</h3>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl p-8 text-center text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <a href="/subscribe" className="px-8 py-3 bg-white text-blue-700 font-bold rounded-lg hover:bg-blue-50">
                Get the Free Daily Brief →
              </a>
              <a href="/demo" className="px-8 py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-400 border border-blue-400">
                See a Sample First →
              </a>
            </div>
          </div>
