  ...
  return (
    <div className="min-h-screen bg-[#e8e6e1]">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-[#2a2a2a] mb-2">Terms of Service</h1>
        ...
        <div className="prose prose-gray max-w-none space-y-6 text-[#555] text-sm leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">3. Accounts &amp; Registration</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">4. Subscriptions &amp; Payments</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">5. Content &amp; Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">6. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">7. Disclaimer of Warranties</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">8. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">9. Termination</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">10. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-semibold text-[#2a2a2a] mt-8 mb-3">11. Governing Law</h2>
          ...
          <section>
            ...
            <p>Questions about these terms? Email <a href="mailto:dustin@foxhomesteam.com" className="text-[#e85d26] hover:underline">dustin@foxhomesteam.com</Link>.</p>
          </section>
        </div>
